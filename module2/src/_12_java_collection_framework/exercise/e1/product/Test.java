...
import _12_java_collection_framework.exercise.e1.product.ProductManager;
import _12_java_collection_framework.exercise.e1.product.Product;
...
public class Test {
    public static void main(String[] args) {
       ...
       // Product product6 = new Product(new ProductManager().id(),"cacao",10200,8);
