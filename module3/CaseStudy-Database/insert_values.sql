...
VALUES
    ...
    (3, 'day'),
    (4, 'hour');
    -- Insert into loai_dich_vu table
INSERT INTO loai_dich_vu (ma_loai_dich_vu, ten_loai_dich_vu)
VALUES
    (1, 'Villa'),
    (2, 'House'),
    (3, 'Room');
-- Insert into dich_vu table
...
-- Insert into dich_vu_di_kem table
...
-- Insert into hop_dong_chi_tiet table
